                ...
                <v-card-title class="d-flex align-center pe-2">
                    ...
                    <v-dialog v-model="dialog" persistent="persistent" width="500">
                        ...
                        <v-card>
                            ...
                            <v-card-text>
                                <v-container>
                                  <v-form @submit.prevent="formUsers">
                                    <v-row>
                                        <v-col cols="12">
                                            <v-text-field :label="$t('users.name')" :rules="rules.name" v-model="formUsers.name" required="required"></v-text-field>
                                        </v-col>
                                        <v-col cols="12">
                                            <v-text-field :label="$t('users.email')" :rules="rules.email" v-model="formUsers.email" required="required"></v-text-field>
                                        </v-col>
                                        <v-col cols="12">
                                            <v-text-field :label="$t('users.password')" :rules="rules.password" v-model="formUsers.password" type="password" required="required"></v-text-field>
                                        </v-col>
                                    </v-row>
                                  </v-form>
                                </v-container>
                    ...
                    <!-- <v-dialog v-model="dialog" persistent="persistent" width="1024">
                        <template v-slot:activator="{ props }">
                            <v-btn
                                ...
                                color="green-darken-1"
                                elevation="6"
                                v-bind="props">{{$t('text.edit')}}</v-btn>
                        </template>

                        <v-card>
                            <v-card-title color="green-darken-2">
                                <span class="text-h5">{{$t('text.edit')}}
                                    User Profile</span>
                            </v-card-title>
                            <v-card-text>
                                <v-container>
                                    <v-row>
                                        ...
                                        <v-col cols="12" sm="6">
                                            <v-autocomplete
                                                ...
                                                label="Interests"
                                                multiple="multiple"></v-autocomplete>
                                        </v-col>
                                    </v-row>
                                </v-container>
                    ...
                    <v-btn rounded="lg" class="mx-1" elevation="6" color="red-darken-1">Delete</v-btn>
